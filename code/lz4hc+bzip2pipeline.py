...
def hybrid_compress(input_file, output_file):
    ...
    compressed_data = bz2.compress(lz4hc_compressed, compresslevel=9)
...
def hybrid_decompress(input_file, output_file):
    ...
    bzip2_decompressed = bz2.decompress(compressed_data)
    decompressed_data = lz4.frame.decompress(bzip2_decompressed).decode()
