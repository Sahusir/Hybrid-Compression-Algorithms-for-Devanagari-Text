...
def hybrid_compress(input_file, output_file):
    ...
    compressed_data = compressor.compress(bzip2_compressed)
...
def hybrid_decompress(input_file, output_file):
    ...
    zstd_decompressed = decompressor.decompress(compressed_data)
    decompressed_data = bz2.decompress(zstd_decompressed).decode()
